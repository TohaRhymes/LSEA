...
```bash
scp ${PANUKB_LSEA_DIR}/aggregated_checks/*__associated_phenos.tsv tests/results/panukb/
```

See `tests/README.md` for full experiment details and `tests/DATA_PREPARATION.md`
for data provenance.
